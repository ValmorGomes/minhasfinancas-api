...
import com.valmor.minhasfinancas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImp implements LancamentoService {
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getUsuario() == null || lancamento.getUsuario().getId() == null) {
			throw new RegraNegocioException("Informa um Usuário cadastrado");		
		}
	...
	public BigDecimal obterSaldoPorUsuario(Long id) {
		...
		return receitas.subtract(despesas); //receita - despesas
	}
